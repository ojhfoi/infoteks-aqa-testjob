...
public class SuccessBookFind {
    ...
    public void test (String searchText) {
        ...
        Assert.assertNotNull(booksAction.lblNoData);
        Assert.assertTrue(booksAction.findBookTitle(searchText));
        int currentBooksCount = booksAction.getBooksCount();
        Assert.assertEquals( currentBooksCount, 1);
    }
